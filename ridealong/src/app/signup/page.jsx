...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative p-4 py-12 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="w-full bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-slate-700/50">
          ...
          <p className="text-sm text-gray-400 mb-6">Join thousands of commuters on RideAlong.</p>
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              ...
              <select
                name="gender"
                className="w-full px-4 py-3 rounded-xl bg-slate-800/80 border border-slate-700/80 text-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition appearance-none"
                required
              >
